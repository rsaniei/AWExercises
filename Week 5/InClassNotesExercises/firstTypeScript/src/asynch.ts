...
var sample_promise = new Promise<void>((resolve, reject) => {
    setTimeout(() => {
...
// // code goes here
const delayedUpperCase:any = (param: string) => {
...
const emp_promise = new Promise<boolean>((resolve, reject) => {
...
.catch((error: string) => console.log("Error if any - ", error));
